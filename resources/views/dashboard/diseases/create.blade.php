...
@section('container')
    ...
    <h1 class="h2">Create New Disease</h1>
  </div> 

  <div class="col-lg-8">
      <form method="post" action="/dashboard/diseases" class="mb-5" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          @enderror
          <input id="keterangan" type="hidden" name="keterangan" value="{{ old('keterangan') }}" autocomplete="off">
        ...
        <div class="mb-3">
          ...
          <p class="text-danger">{{ $message }}</p>
          @enderror
          <input id="pengendalian" type="hidden" name="pengendalian" value="{{ old('pengendalian') }}" autocomplete="off">
          <trix-editor input="pengendalian"></trix-editor>
        </div>
        <div class="mb-3">
          <label for="probabilitas" class="form-label">Nilai Probabilitas</label>
          <input type="decimal" class="form-control @error('probabilitas') is-invalid @enderror" id="probabilitas" name="probabilitas" required autofocus value="{{ old('probabilitas') }}" autocomplete="off">
          @error('probabilitas')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
